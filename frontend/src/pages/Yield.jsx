...
import { Typography, Paper, Button, TextField, Box, Grid, CircularProgress, Alert } from '@mui/material'
          ...
          <Paper sx={{ p: 3 }}>
            ...
            <form onSubmit={handlePredict}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <TextField label="Region / State" value={predictForm.region} onChange={(e) => setPredictForm((f) => ({ ...f, region: e.target.value }))} required />
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3 }}>
            ...
            <form onSubmit={handleSuggest}>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <TextField label="Region / State" value={suggestForm.region} onChange={(e) => setSuggestForm((f) => ({ ...f, region: e.target.value }))} required />
